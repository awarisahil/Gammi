...
const TILE_SIZE = 50;
const WHITE_TILE_COLOR = "#AFB0B0";
const BLACK_TILE_COLOR = "#2D2F2F";
const HIGHLIGHT_COLOR = "#736273";
const WHITE = 0;
const BLACK = 1;
    ...
    for (let i = 0; i < BOARD_HEIGHT; i++) {
        for (let j = 0; j < BOARD_WIDTH; j++) {
            ...
            if (board.tiles[i][j].team === WHITE) {
                chessCtx.fillStyle = "#fff";
            } else {
                chessCtx.fillStyle = "#000";
            }
